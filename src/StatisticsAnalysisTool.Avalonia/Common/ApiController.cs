...
using StatisticsAnalysisTool.Avalonia.Exceptions;
using StatisticsAnalysisTool.Avalonia.Models;
using StatisticsAnalysisTool.Avalonia.Models.ApiModel;
...
namespace StatisticsAnalysisTool.Avalonia.Common
{
    public static class ApiController
    {
        ...
        public static async Task<List<MarketResponse>> GetCityItemPricesFromJsonAsync(string uniqueName, List<Location>? locations, List<int>? qualities)
        {
            ...
            var url = SettingsController.CurrentUserSettings.CityPricesApiUrl;
            url += uniqueName;
            ...
            try
            {
                ...
                return result != null ? MergeCityAndPortalCity(result) : null!;
            }
            ...
            DateTime? date, IList<int>? qualities, int timeScale = 24)
        {
            ...
            var url = SettingsController.CurrentUserSettings.CityPricesHistoryApiUrl ?? ApplicationSettings.CityPricesHistoryApiUrlDefault;
            url += uniqueName;
        ...
        public static async Task<List<GoldResponseModel>> GetGoldPricesFromJsonAsync(DateTime? dateTime, int count, int timeout = 300)
        {
            ...
            var url = $"{SettingsController.CurrentUserSettings.GoldStatsApiUrl ?? ApplicationSettings.GoldStatsApiUrlDefault}?date={checkedDateTime}&count={count}";
        ...
        public static async Task<List<Donation>> GetDonationsFromJsonAsync()
        {
            ...
            var url = ApplicationSettings.DonationsUrl;
